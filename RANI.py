...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY DEVIL-X tarmux gurop GROUP")
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/861086515824952/')
#------------------[ Devil-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
princp=[]
try:
    prox= requests.get('https://github.com/devil-x91/Aprovel/blob/main/Aprove.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/devil-x91/Aprovel/blob/main/Aprove.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/profile.php?id=61557765514308')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system("xdg-open https://facebook.com/groups/861086515824952/")
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38m LIGHT YAGAMI]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Ravan King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mhttps://github.com/devil-x91 ]   ║\33[1;34m   
╠══[Whatsapp                 • NO ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  LIGHT YAGAMI  Tools"')
pass
